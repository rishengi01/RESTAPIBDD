...
import qa.util.Weather;

public class SerializationDeseriExample {
	...
	public void weatherserialize() throws JsonGenerationException, JsonMappingException, IOException
	{
		...
		weather.setWindDirectionDegree("180 Degree");
		 ...
		 ObjectMapper mapper = new ObjectMapper();
	            ...
	            mapper.writeValue(new File("Weather.json"), weather);
	...
	public void deserialize() throws IOException
	{
		...
		// JSON file to Java object
         Weather weather1 = mapper.readValue(new File("Weather.json"), Weather.class);

         // JSON string to Java object
         //jsonstring we have to fetch after get request(whether we use rest assured or anything else)
         String jsonInString = "{\"weatherDescription\":\"scattered clouds\",\"windDirectionDegree\":\"180 Degree\",\"city\":\"Hyderabad1\",\"humidity\":\"59 Percent\",\"windSpeed\":\"1.5 Km per hour\",\"temperature\":\"31.68 Degree celsius\"}";
         Weather weather2 = mapper.readValue(jsonInString, Weather.class);
